...
#pragma region // CSyghUV2SVGApp

BEGIN_MESSAGE_MAP(CSyghUV2SVGApp, CWinApp)
END_MESSAGE_MAP()


CSyghUV2SVGApp::CSyghUV2SVGApp()
{
...
// 唯一の CSyghUV2SVGApp オブジェクトです。

CSyghUV2SVGApp g_theApp;


BOOL CSyghUV2SVGApp::InitInstance()
{
