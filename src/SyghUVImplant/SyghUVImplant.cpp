...
#pragma region // CSyghUVImplantApp

BEGIN_MESSAGE_MAP(CSyghUVImplantApp, CWinApp)
END_MESSAGE_MAP()


CSyghUVImplantApp::CSyghUVImplantApp()
{
...
// 唯一の CSyghUVImplantApp オブジェクトです。

CSyghUVImplantApp g_theApp;


BOOL CSyghUVImplantApp::InitInstance()
{
