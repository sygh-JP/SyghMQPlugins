...
#pragma region // CSyghUVSelectUtilApp

BEGIN_MESSAGE_MAP(CSyghUVSelectUtilApp, CWinApp)
END_MESSAGE_MAP()


CSyghUVSelectUtilApp::CSyghUVSelectUtilApp()
{
...
// 唯一の CSyghUVSelectUtilApp オブジェクトです。

CSyghUVSelectUtilApp g_theApp;


BOOL CSyghUVSelectUtilApp::InitInstance()
{
