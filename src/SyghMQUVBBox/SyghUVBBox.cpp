...
#pragma region // CSyghUVBBoxApp

BEGIN_MESSAGE_MAP(CSyghUVBBoxApp, CWinApp)
END_MESSAGE_MAP()


CSyghUVBBoxApp::CSyghUVBBoxApp()
{
...
// 唯一の CSyghUVBBoxApp オブジェクトです。

CSyghUVBBoxApp g_theApp;


BOOL CSyghUVBBoxApp::InitInstance()
{
